...
import { CalendarTick, PresentionChart, Teacher, Briefcase } from "iconsax-react";
import {
  CartesianGrid,
  Legend,
  Line,
...
function Dashboard() {
  ...
  const fetchWidgetData = async () => {
    const response = await fetch('http://localhost:5008/api/Dashboard/DashboarCountdwidget')
    const data = await response.json();
    setWidgetData(data);
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="bg-white bg-opacity-20 p-4 rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-600">{widgetData.usersCount}</p>
            </div>
          ...
          <div className="bg-white bg-opacity-20 p-4 rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-600">{widgetData.availabilityCount}</p>
            </div>
            <div className=" rounded-full p-2">
          ...
          <div className="bg-white bg-opacity-20 p-4 rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-600">{widgetData.presentationCount}</p>
            </div>
            <div className=" rounded-full p-2">
          ...
          <div className="bg-white bg-opacity-20 p-4 rounded-lg flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-600">{widgetData.scheduleCount}</p>
            </div>
            <div className=" rounded-full p-2">
