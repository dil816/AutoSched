...
const ExaminarAvailability = () => {
  ...
  const handleAddAvailability = () => {
    navigate("/availability/addavailability");
  };
      ...
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center space-x-4">
          <span className="text-gray-600 font-medium">
            Availability Count {availabilitydata.length}
          </span>
        ...
        <table className="w-full text-left">
          <thead>
            <tr className="text-gray-500 border-b">
              ...
              <th className="py-3 px-4">Examinar</th>
          ...
          <tbody>
            {availabilitydata.map((availability, index) => (
              <tr key={index} className="border-b hover:bg-gray-50">
                ...
                <td className="py-3 px-4 flex items-center">
                  ...
                  <div>
                    <p className="text-gray-800">
                      {availability?.examinarName}
                    </p>
                    <p className="text-gray-500 text-sm">test</p>
                  </div>
                </td>
                <td className="py-3 px-4 text-gray-600">{availability.date}</td>
                ...
                <td className="py-3 px-4 text-gray-600">
                  <Link to={`/availability/addavailability/${availability.id}`}>
                    Update
                  </Link>
                </td>
                <td className="py-3 px-4 text-gray-600">
...
export default ExaminarAvailability;
